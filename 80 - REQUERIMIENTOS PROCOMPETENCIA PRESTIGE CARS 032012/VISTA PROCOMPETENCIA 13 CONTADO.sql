DROP VIEW dbo.VW_PROCOMPETENCIA_13_CONTADO
GO

CREATE VIEW dbo.VW_PROCOMPETENCIA_13_CONTADO
AS
...
WHERE Y.CODOPER='01-301' AND (y.TipoFac = 'A') AND (y.NumeroR IS NULL OR y.NumeroR = '') AND (Y.FechaE >= CONVERT(DATETIME, '04/01/2009', 120))
...
declare @TNAME CHAR(28)
declare @ALIAS CHAR(28)
SET @TNAME = 'VW_PROCOMPETENCIA_13_CONTADO'
SET @ALIAS = 'VW_PROCOMPETENCIA_13_CONTADO'
