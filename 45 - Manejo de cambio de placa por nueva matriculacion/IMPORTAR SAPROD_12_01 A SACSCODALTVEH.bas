...
'File Name: e:\Documents and Settings\jravelo\Mis documentos\CONCESIONARIOS\SAINT\SOLUCIONES\45 - MANEJO DE CAMBIO DE PLACA\IMPORTAR SAPROD_12_01 A SACSCODALTVEH.bas
'Package Name: Nuevo paquete
'Package Description: Descripción del paquete DTS
'Generated Date: 12/07/2008
'Generated Time: 23:49:44
'****************************************************************
...
Public Sub oCustomTask1_Trans_Sub1(ByVal oCustomTask1 As Object)
	...
	Set oTransProps = oTransformation.TransformServerProperties
		...
		oTransProps("Text") = oTransProps("Text") & "	DTSDestination(""CodAlt"") = DTSSource(""SERIAL"")" & vbCrLf
		oTransProps("Text") = oTransProps("Text") & "	DTSDestination(""Tipo"") = ""1""" & vbCrLf
