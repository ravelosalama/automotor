-- VISTA QUE MUESTRA LAS NOTAS DE ENTREGAS SOBRE ORDENES GAR INT ACC  
-- APLICACION: COMPLEMENTO SOLUCION 76 / REPORTES AGREGADOS 201 
-- REALIZADO EL:08/07/2011 POR: JOSE RAVELO

DROP VIEW dbo.SESA_VW_REPUESTOS_ENTREGADOS
GO
 
 
CREATE VIEW dbo.SESA_VW_REPUESTOS_ENTREGADOS
WITH ENCRYPTION
...
SET @TNAME = 'SESA_VW_REPUESTOS_ENTREGADOS'
SET @ALIAS = 'SESA_VW_REPUESTOS_ENTREGADOS'
